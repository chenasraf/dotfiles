...
local on_attach = function(_, bufnr)
  ...
  -- vim.keymap.set('n', 'ga', vim.lsp.buf.code_action, { desc = '[C]ode [A]ction', silent = true })
  -- vim.keymap.set({ 'n', 'i', 'v' }, '<F4>', vim.lsp.buf.code_action, { desc = '[C]ode [A]ction', silent = true })
