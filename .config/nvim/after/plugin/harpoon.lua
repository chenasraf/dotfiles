...
vim.keymap.set('n', '<C-g>', ui.toggle_quick_menu, { desc = "Toggle Harpoon Quick Menu" })
-- vim.keymap.set('n', '<C-t>', '<Cmd>Telescope harpoon marks<CR>', { desc = "Toggle Harpoon Telescope" })
